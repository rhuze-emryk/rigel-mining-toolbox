...
# mine to shardpool
./rigel -a zil -o zmp+tcp://us1-zil.shardpool.io:3333 -u YOUR_ZIL_WALLET --log-file logs/miner.log

# mine to crazypool
#./rigel -a zil -o stratum+tcp://us.crazypool.org:5005 -u YOUR_ZIL_WALLET --log-file logs/miner.log
